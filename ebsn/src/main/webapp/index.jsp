...
<div id="container" style="background-image:url(/image/background.jpg);">
    ...
    <div id="city" style="background-image: url(/image/shenyang.png);height: 200px;width:80%;float:left;margin: 0 0 0 150px">
    ...
    <div id="hot" style="background:lawngreen;height: 500px;width:80%;float:left;margin: 0 0 0 150px">
        <%@include file="/jsp/hot2/hot.jsp" %>
    </div>
