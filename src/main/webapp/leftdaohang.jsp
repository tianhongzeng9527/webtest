...
<DIV class="table1" id="Layer1" style="Z-INDEX: 3; LEFT: 50px; WIDTH: 26px; POSITION: absolute; TOP: 0px; HEIGHT: 100%">
    <DIV id="sl1" onmouseover="showM1()" style="Z-INDEX: 3; WIDTH: 24px; CURSOR: hand; POSITION: absolute; TOP: 40px; HEIGHT: 24px" onmouseout="hideM1()"><img height=24 src="/ad/zzjs.gif" width="24"  style="cursor:pointer;"/></DIV>
    <DIV id="sl2" onmouseover="showM2()" style="Z-INDEX: 3; WIDTH: 24px; CURSOR: hand; POSITION: absolute; TOP: 140px; HEIGHT: 24px" onclick="subMenu1()" onmouseout="hideM2()"><img height=24 src="/ad/zzjs.gif" width="24"  style="cursor:pointer;"/></DIV>
    <DIV id="sl3" onmouseover="showM3()" style="Z-INDEX: 3; WIDTH: 24px; CURSOR: hand; POSITION: absolute; TOP: 240px; HEIGHT: 24px" onmouseout="hideM3()"><img height=24 src="/ad/zzjs.gif" width="24"  style="cursor:pointer;"/></DIV>
    <DIV id="sl4" onmouseover="showM4()" style="Z-INDEX: 3; WIDTH: 24px; CURSOR: hand; POSITION: absolute; TOP: 340px; HEIGHT: 24px" onmouseout="hideM4()"><img height=24 src="/ad/zzjs.gif" width="24"  style="cursor:pointer;"/></DIV>
...
<DIV style="Z-INDEX: 2; LEFT: -60px; WIDTH: 30px; POSITION: absolute; TOP: 0px; HEIGHT: 100px">
    <DIV id="menu1" style="Z-INDEX: 5; LEFT: 82px; WIDTH: 20px; POSITION: absolute; TOP: -80px; HEIGHT: 55px"><img height="20" src="/img/1001274.gif" width="24"  style="cursor:pointer;"/></DIV>
    <DIV id="menu2" style="Z-INDEX: 5; LEFT: 82px; WIDTH: 23px; POSITION: absolute; TOP: -80px; HEIGHT: 75px"><img height="20" src="/img/1001274.gif" width="24"  style="cursor:pointer;"/></DIV>
    <DIV id="menu3" style="Z-INDEX: 5; LEFT: 82px; WIDTH: 22px; POSITION: absolute; TOP: -80px; HEIGHT: 75px"><img height="20" src="/img/1001274.gif" width="24"  style="cursor:pointer;"/></DIV>
    <DIV id="menu4" style="Z-INDEX: 5; LEFT: 82px; WIDTH: 23px; POSITION: absolute; TOP: -80px; HEIGHT: 77px"><img height="20" src="/img/1001274.gif" width="24"  style="cursor:pointer;"/></DIV></DIV>
<DIV class="maskl" id="masksub" style="Z-INDEX: 4; LEFT: 80px; WIDTH: 32px; POSITION: absolute; TOP: 0px; HEIGHT: 100%">
    <DIV id=sub2
        ...
        <TABLE class="submenu" height="100%" cellSpacing="2" cellPadding="0" width="100%" border="0">
            ...
            <TR>
                <TD onmouseover="this.bgColor='#9999cc'" onmouseout="this.bgColor='#666699'" bgColor="#666699" height="10">
                    <DIV style="CURSOR: hand" onclick="subClose1()" align="center"><B><FONT color="#ffff00">B</FONT></B></DIV></TD></TR></TBODY></TABLE></DIV></DIV>
</body>